package com.uwindsor.ecommerce.order.config;
...
public class RabbitMQConfig {
    ...
    /**
     * Inventory Reserved Queue - Consumed by Order Service from Inventory Service
     */
    @Bean
    ...
    /**
     * Inventory Failed Queue - Consumed by Order Service from Inventory Service
     */
    @Bean
